...
namespace prune {
  ...
  hb_enc::hb_vec apply_prune_chain(const tara::prune::prune_chain& prune_chain, hb_enc::hb_vec& hbs, const z3::model& m, unsigned int print_pruning, std::ostream& print_out, const hb_enc::encoding& hb_encoding);
